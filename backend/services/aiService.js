...
let openai;
const MODEL_NAME = "google/gemini-2.0-flash-001"; // Standard Flash 2.0 Model
...
export const generateChatResponse = async (context, query) => {
    ...
    if (!openai) return "AI Service Unavailable: API Key missing.";
    ...
    try {
        ...
        if (error.status === 402 || error.status === 429) {
            return "⚠️ **Quota Exceeded**: Your OpenRouter credits are exhausted or the free model is busy.";
        }
