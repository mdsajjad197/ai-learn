...
import { FileText, Search, Plus, Calendar, ArrowRight, Trash2, Layout, BarChart2 } from 'lucide-react';
...
const Documents = () => {
    ...
    const [activeTab, setActiveTab] = useState('documents'); // 'documents' or 'efficiency'
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 animate-fade-in relative min-h-screen">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                <div>
                    <h1 className="text-3xl font-heading font-bold text-gray-900">Documents & Insights</h1>
                    <p className="mt-2 text-gray-500 max-w-xl">
                        Manage your files and track your learning progress.
                    </p>
                </div>
                ...
                <div className="flex bg-white p-1 rounded-xl border border-gray-200 shadow-sm">
                    <button
                        ...
                        className={`flex items-center px-4 py-2 rounded-lg text-sm font-medium transition-all ${activeTab === 'documents'
                    ...
                    <button
                        ...
                        className={`flex items-center px-4 py-2 rounded-lg text-sm font-medium transition-all ${activeTab === 'efficiency'
                            ? 'bg-indigo-600 text-white shadow-md'
                            : 'text-gray-600 hover:bg-gray-50'
                            }`}
                    >
